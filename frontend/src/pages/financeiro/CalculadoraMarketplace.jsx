 ...
 *   Suporta busca por SKU para pré-preencher custo, preço e peso do catálogo.
 * @version 1.2.0
 * @date 2026-04-24
 * @changelog
 *   1.2.0 — 2026-04-24 — Busca por SKU: puxa precoCusto, preco e weight do Firestore via API.
        ...
        <div className="rounded-xl bg-slate-800 border border-white/5 p-4">
          ...
          {skuStatus && skuStatus !== 'loading' && skuStatus !== 'error' && (
            <div className="flex items-center gap-2 mt-2">
              ...
              <button onClick={limparSKU} className="text-slate-500 hover:text-slate-300 transition-colors shrink-0">
                <X size={13} />
              </button>
            </div>
          )}
